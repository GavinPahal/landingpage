    ...
    <section className="features">
      <div className="infoCards">
        ...
        <div className="card">
          ...
          <p> An AI Chatbot provides instant, personalized help with food safety, ingredient details, and travel-specific allergy info, 
            guiding users through unfamiliar cuisines and regulations.
